      ...
      <el-table-column fixed="right" label="操作" >
        <template v-slot="scope" #default >
          ...
          <el-popconfirm title="确认要删除该书籍吗?" @confirm="deleteBook(scope.row)">
            <template #reference>
              <el-button :disabled='deletedisabled' style="margin: 20px" type="primary" slot="reference">删除图书</el-button>
            </template>
          </el-popconfirm>
          <el-button style="margin: 20px" type="success" @click="rentOrreturn(scope.row.isbn,scope.row.status)">借阅/归还图书</el-button>
          <el-dialog title="借阅书籍" v-model="rentBookVisible" v-slot="scope">
            ...
            />
            <el-button  style="margin: 20px" type="primary" slot="reference" @click="rentBook(2023-0o6-28,2023-0o6-29,scope.row.isbn)">借阅图书</el-button>
          </el-dialog>
